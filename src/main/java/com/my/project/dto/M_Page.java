...
public class M_Page {
	...
	public M_Page(String findkey, String findvalue, int curPage, int perPage, int perBlock, int totPage, int startNum,
	...
	public String toString() {
		return "M_Page [findkey=" + findkey + ", findvalue=" + findvalue + ", curPage=" + curPage + ", perPage=" + perPage
